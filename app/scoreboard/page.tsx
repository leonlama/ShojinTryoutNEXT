    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-gray-100 dark:bg-gray-400 rounded-lg shadow-lg overflow-hidden">
                    <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                        <h2 className="text-2xl font-semibold mb-4">Top Players</h2>
                        
                        <div className="space-y-4">
                            {/* Top Player Card */}
                            <div className="flex items-center justify-between bg-white dark:bg-gray-500 p-4 rounded-lg">
