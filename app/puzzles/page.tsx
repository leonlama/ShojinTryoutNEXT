            ...
            <div className="max-w-4xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-gray-100 dark:bg-gray-400 rounded-lg shadow-lg p-6">
                        ...
                        <div className="aspect-square bg-gray-200 dark:bg-gray-600 mb-4">
                            {/* Chess board will be rendered here */}
                        </div>
                        <div className="space-y-2">
                            <p className="font-medium">White to move - Mate in 2</p>
                            <p className="text-sm text-gray-600 dark:text-gray-800">Difficulty: ★★★☆☆</p>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-400 rounded-lg shadow-lg p-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-500 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800">
                                <span>Evolution Tactics</span>
                                <span className="text-sm text-gray-600 dark:text-gray-300">24 puzzles</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-500 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800">
                                <span>Jinsho Patterns</span>
                                <span className="text-sm text-gray-600 dark:text-gray-300">18 puzzles</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-500 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800">
                                <span>Shield Knight Defense</span>
                                <span className="text-sm text-gray-600 dark:text-gray-300">15 puzzles</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-500 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800">
                                <span>Assassin Combinations</span>
                                <span className="text-sm text-gray-600 dark:text-gray-300">21 puzzles</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-900 rounded-lg">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-300">Solved in 2:45</p>
                                </div>
                            ...
                            <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-900 rounded-lg">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-300">Solved in 4:12</p>
                                </div>
                                <span className="text-green-500">✓</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-900 rounded-lg">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-300">Failed attempt</p>
                                </div>
